...
local scene= composer.newScene("hard")
...
--All objects excluding spawning ones ------------------------------------------------------------------- 
...
man.type = "man"
 ...
 pit = display.newImageRect(sceneGroup, "pit.png" ,587, 100 )
...
--speed of objects
local rockvelocity = -95
local velocityamount = 8
local velocity= -250
...
timer.performWithDelay( 50, add, 0)
--Makes ground move 
...
local function endGame()
	...
	Runtime:removeEventListener("enterFrame", removebodies)
...
--rock spawning and collision --------------------------------------------------------------------------------------------
local function spawnRock(event)
...
timer.performWithDelay(  9000, spawnRock, delayTime)



-- Spear Spawning and collision -------------------------------------------------------------------------------------------------------------------------
local function spawnSpear(event)
...
--spawning rocks and collision------------------------------------------------------------------------------------------
 local function spawnRock1(event)
