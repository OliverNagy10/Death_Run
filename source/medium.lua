...
local scene= composer.newScene("medium")
...
--speed of objects
local rockvelocity = -80
local velocityamount = 4
local velocity= -210
...
------------------------------------------------------------------------------------------------
--Physics Bodys exculding the spawing bodies --------------------------------------------------
...
timer.performWithDelay( 100, add, 0)
--Makes ground move ------------------------------------------------------------------------------------------------
...
timer.performWithDelay(  9000, spawnSpear, delayTime)


-- rocks spawing and collision--------------------------------------------------------------------------------------------------------- 
